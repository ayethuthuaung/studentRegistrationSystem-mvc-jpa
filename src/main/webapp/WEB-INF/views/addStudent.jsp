												...
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<form:input type="text" class="form-control"
															value="<%= formattedStudentId %>" path="studentId" disabled="disabled" readonly="true" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<form:input type="text" class="form-control" path="name" id="studentNameInput"/>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<form:input type="text" class="form-control" path="phone" id="studentPhoneInput"/>
											...
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<form:input type="email" class="form-control" path="email" id="studentEmailInput"/>
											...
											<div class="col-md-6">
												<div class="form-group row">
													<label class="col-sm-3 col-form-label">Date of
														Birth</label>
													<div class="col-sm-9">
														<form:input type="date" class="form-control" path="dob" id="studentDOBInput"/>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<form:input type="text" class="form-control" path="education" id="studentEducationInput"/>
                ...
                ${course.name}
										...
										<div class="mt-3">
											<button 
												...
												id="studentSubmitButton">Add</button>
											<button type="reset"
